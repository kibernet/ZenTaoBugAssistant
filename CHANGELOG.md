...
- Removed internal default server URLs from packaged defaults.
- Removed VS Code production debug telemetry hooks.
- Added privacy and support documentation for both plugin packages.

## 1.0.0

- Initial dual-plugin release.
